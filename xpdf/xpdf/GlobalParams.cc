...
GString* GlobalParams::getRelativeFile(GString *relative, GString *baseFile)
{
	if (isAbsolutePath(relative->getCString()))
	{
		return relative->copy();
	}

	GString* path = grabPath(baseFile->getCString());
	appendToPath(path, relative->getCString());
...
void GlobalParams::parseNameToUnicode(GList *tokens, GString *fileName,
  ...
  name = getRelativeFile((GString *)tokens->get(1), fileName);
...
void GlobalParams::parseCIDToUnicode(GList *tokens, GString *fileName,
  ...
  cidToUnicodes->add(collection->copy(), getRelativeFile(name, fileName));
}
...
void GlobalParams::parseUnicodeToUnicode(GList *tokens, GString *fileName,
  ...
  unicodeToUnicodes->add(font->copy(), getRelativeFile(file, fileName));
}
...
void GlobalParams::parseUnicodeMap(GList *tokens, GString *fileName,
  ...
  unicodeMaps->add(encodingName->copy(), getRelativeFile(name, fileName));
}
...
void GlobalParams::parseCMapDir(GList *tokens, GString *fileName, int line) {
  ...
  list->append(getRelativeFile(dir, fileName));
}
...
void GlobalParams::parseToUnicodeDir(GList *tokens, GString *fileName,
  ...
  toUnicodeDirs->append(getRelativeFile((GString *)tokens->get(1), fileName));
}
